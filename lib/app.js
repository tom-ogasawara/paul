...
const controls_menu = new Object("docs/Player/controls.png", 285, 435, 70, 70);
const controls_text = new Object("docs/transparent_text_effect.png", 35, 515, 70, 70);
...
spike[1] = new Object("docs/Items/spikes.png", 4445, 280, 70, 70);
spike[2] = new Object("docs/Items/spikes.png", 4515, 280, 70, 70);

spike[3] = new Object("docs/Items/spikes.png", 4935, 420, 70, 70);
spike[4] = new Object("docs/Items/spikes.png", 5005, 420, 70, 70);

spike[5] = new Object("docs/Items/spikes.png", 7245, 280, 70, 70);
spike[6] = new Object("docs/Items/spikes.png", 7315, 280, 70, 70);
...
function Animate() {
  ...
  controls_text.x -= player.vel_x * 2;
  controls_menu.x -= player.vel_x * 2;
  ...
  ctx.drawImage(controls_text.sprite, controls_text.x, controls_text.y);
  ...
  if (player.vel_y === 0 && player.vel_x === 0) {
    ...
    player.sprite.src = "docs/Player/p1_walk/PNG/p1_walk04L.png";
  } else {
    player.sprite.src = "docs/Player/p1_stand.png";
  }
